...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "pai": {
            "img_dir": "/workspace/datasets/custom-data/pai-toy-data/images",
            "roidb_file": "/workspace/datasets/custom-data/pai-SGG-with-attri.h5",
            "dict_file": "/workspace/datasets/custom-data/pai-SGG-dicts-with-attri.json",
            "image_file": "/workspace/datasets/custom-data/image_data.json",
        },
    }

        # "pai_with_attribute": {
        #     "img_dir": "custom-data/pai-toy-data/images",
        #     "roidb_file": "custom-data/pai-SGG-with-attri.h5",
        #     "dict_file": "custom-data/pai-SGG-dicts-with-attri.json",
        #     "image_file": "custom-data/image_data.json",
        # },
