...
from maskrcnn_benchmark.data.datasets.evaluation.pai.sgg_eval import SGRecall, SGNoGraphConstraintRecall, SGZeroShotRecall, SGNGZeroShotRecall, SGPairAccuracy, SGMeanRecall, SGNGMeanRecall, SGAccumulateRecall

def do_pai_evaluation(
    cfg,
    dataset,
    predictions,
    output_folder,
    ...
    # get zeroshot triplet ---- Note: Need to update to use pai zero-shot triplets ----
    ...
    if "bbox" in iou_types:
        ...
        fauxcoco = COCO()
        fauxcoco.dataset = {
            'info': {'description': 'use coco script for pai detection evaluation'},
